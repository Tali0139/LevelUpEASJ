...
namespace LevelUpEASJ.View
{
    ...
    /// </summary>
    public sealed partial class ListOfExercises : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            NameOfTrainer_Box.Text = luvm.trainerSingleton.NyTrainer.FirstName + " " +
                                     luvm.trainerSingleton.NyTrainer.LastName;
